		...
		<div class="col-md-8">
			<div class="card" style="background-color:transparent;">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong><a href="https://t.me/madameong">t.me/madameong</a></strong></h4>
                    <a  
					style="width:140px;"
					></a>
					</h4>
...
Swal.fire({ title: "Warning!", text: "Join our Telegram t.me/madameong", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
